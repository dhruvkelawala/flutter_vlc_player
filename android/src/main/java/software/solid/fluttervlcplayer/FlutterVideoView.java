...
//        });
    ...
    // Suppress WrongThread warnings from IntelliJ / Android Studio, because it
    ...
    public void onEvent(MediaPlayer.Event event) {
        ...
        switch (event.type) {
            case MediaPlayer.Event.Playing:
                ...
                Media.VideoTrack currentVideoTrack = (Media.VideoTrack) mediaPlayer.getMedia()
                        .getTrack(mediaPlayer.getVideoTrack());
